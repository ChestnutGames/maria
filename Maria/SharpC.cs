...
namespace Maria {
    public class SharpC : DisposeObject {
        ...
        public delegate int pfunc(int argc, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = maxArgs)] CSObject[] argv, int res);
        ...
        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr sharpc_retain(pfunc func);

        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void sharpc_release(IntPtr self);

        [DllImport(DLL, CallingConvention = CallingConvention.Cdecl)]
        public static extern void sharpc_callc(IntPtr self, int argc, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = maxArgs)] CSObject[] argv, int res);
        ...
        public static int CallCSharp(int argc, [In, Out, MarshalAs(UnmanagedType.LPArray, SizeConst = maxArgs)] CSObject[] argv, int res) {
            UnityEngine.Debug.Assert(argc > 0);
            CSObject o = argv[0];
            if (o.type == CSType.SHARPFUNCTION) {
                pfunc f = (pfunc)cache.Get(o.v32);
                return f(argc, argv, res);
            }
            return 0;
        }
